...
\section{Pertidaksamaan Linier}
	...
	\subsection{Contoh Soal}
		...
		\begin{frame}{Jawaban Contoh 3}
			...
			\begin{equation*}
				\left\{ x:-\frac{11}{2} \leq x \leq -1 \right\}
			\end{equation*}
		...
		\begin{frame}
			...
			\end{align*}
			\begin{itemize}
				\item Dapat dilihat bahwa $ x = -\frac{2}{3}$ dan $ x = 1 $ membagi garis bilangan ke dalam tiga selang tertutup yaitu $ (-\infty, -3] $, $ [-3 , 1] $, dan $ [1, +\infty) $.
			\end{itemize}
		\end{frame}
